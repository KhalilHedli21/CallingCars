      ...
      cars: [
        {
          ...
          description: 'Tesla Model S 2025 avec autonomie améliorée et performances exceptionnelles.'
        },
        {
          id: 2,
          make: 'BMW',
          ...
          fuelType: 'Électrique',
          transmission: 'Automatique',
          description: 'BMW i4 2025, une berline électrique élégante avec un design moderne.'
        },
        {
          id: 3,
          make: 'Mercedes-Benz',
          ...
          fuelType: 'Électrique',
          transmission: 'Automatique',
          description: 'Mercedes-Benz EQS 2025, luxe et technologie de pointe.'
        }
      ],
      favorites: [],
      loading: false,
